...
Один пользователь Telegram (users.id) может иметь несколько привязок.
Ограничения (если они нужны) реализуются на уровне сервиса/валидации, а не на уровне БД.
"""
