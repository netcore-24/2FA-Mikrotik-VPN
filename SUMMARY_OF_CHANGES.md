...
| [INSTALL.md](INSTALL.md) | ⚙️ Установка | Обновлен |

### Что читать в первую очередь

1. **[SYSTEM_WORKFLOW.md](SYSTEM_WORKFLOW.md)** - ОБЯЗАТЕЛЬНО для понимания системы
2. **[docs/system_flow_diagram.md](docs/system_flow_diagram.md)** - Для визуального понимания
3. **[INSTALL.md](INSTALL.md)** - Для быстрой установки и запуска
